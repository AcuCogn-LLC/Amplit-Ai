        ...
        <div className="flex flex-col md:flex-row items-center w-full gap-8">
          ...
          <div className="flex-1 max-w-xl text-center md:text-left">
            ...
            >
              ...
              <span className="text-xs font-semibold text-brand tracking-wide">  Clinical AI · Dental Practices</span>
            </motion.div>
            ...
            >
              Meet Acucogn AI, Ambient AI Clinical Documentation.
            </motion.h1>
            ...
            >
              ...
              <span className="text-sm text-black/60 font-medium ml-8">Talk to Acucogn AI!</span>
            </motion.div>
          </div>
